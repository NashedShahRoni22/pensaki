  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="border-navy text-navy hover:border-uclablue hover:bg-uclablue group inline-flex items-center gap-1 rounded border py-2 pl-4 pr-3 text-lg font-medium capitalize transition-colors duration-200 ease-in-out hover:text-white"
      >
